...
class PlayerXPStatus:
    ...
    def draw( self, screen ):
        ...
        if self.last_xp != xp:
            ...
            text = "XP: % 4d" % xp
            if self.bgcolor:
                self.image = self.font.render( text, True, self.fgcolor,
                                               self.bgcolor )
            else:                
                self.image = self.font.render( text, True, self.fgcolor )
...
class Game:
    ...
    def load_images( self ):
        ...
        self.image_player     = pygame.image.load( p + "nave.png" )
        self.image_enemy      = pygame.image.load( p + "inimigo.png" )
        self.image_fire       = pygame.image.load( p + "tiro.png" )
        self.image_enemy_fire = pygame.image.load( p + "tiro_inimigo.png" )
    # load_images()
